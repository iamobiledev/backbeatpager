//#region ../../node_modules/.pnpm/@neondatabase+serverless@1.1.0/node_modules/@neondatabase/serverless/index.mjs
...
var O = (r) => Dn(Ie({}, "__esModule", { value: !0 }), r);
...
var Nn = T((Qt) => {
	...
	Qt.read = function(r, e, t, n, i) {
		...
		if (s === 0) s = 1 - l;
			...
			if (s === c) return o ? NaN : (A ? -1 : 1) * Infinity;
	...
	Qt.write = function(r, e, t, n, i, s) {
		...
		for (e = Math.abs(e), isNaN(e) || e === Infinity ? (u = isNaN(e) ? 1 : 0, o = f) : (o = Math.floor(Math.log(e) / Math.LN2), e * (c = Math.pow(2, -o)) < 1 && (o--, c *= 2), o + y >= 1 ? e += g / c : e += g * Math.pow(2, 1 - y), e * c >= 2 && (o++, c /= 2), o + y >= f ? (u = 0, o = f) : o + y >= 1 ? (u = (e * c - 1) * Math.pow(2, i), o = o + y) : (u = e * Math.pow(2, y - 1) * Math.pow(2, i), o = 0)); i >= 8; r[t + A] = u & 255, A += C, u /= 256, i -= 8);
...
var ii = T((Be) => {
	...
	function Mo() {
		try {
			let r = /* @__PURE__ */ new Uint8Array(1), e = { foo: a(function() {
				return 42;
			}, "foo") };
	...
	function zn(r, e) {
		...
		for (;;) switch (e) {
			...
			case "utf8":
			case "utf-8": return Ht(r).length;
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return t * 2;
			case "hex": return t >>> 1;
			case "base64": return ni(r).length;
			default:
	...
	function No(r, e, t) {
		...
		for (r || (r = "utf8");;) switch (r) {
			case "hex": return Zo(this, e, t);
			case "utf8":
			case "utf-8": return Yn(this, e, t);
			case "ascii": return Ko(this, e, t);
			case "latin1":
			case "binary": return Yo(this, e, t);
			case "base64": return Vo(this, e, t);
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return Jo(this, e, t);
			default:
	...
	h.prototype.write = a(function(e, t, n, i) {
		...
		let o = !1;
		for (;;) switch (i) {
			case "hex": return Wo(this, e, t, n);
			case "utf8":
			case "utf-8": return jo(this, e, t, n);
			case "ascii":
			case "latin1":
			case "binary": return Ho(this, e, t, n);
			case "base64": return $o(this, e, t, n);
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return Go(this, e, t, n);
			default:
			...
			if (i + u <= t) {
				...
				switch (u) {
					...
					case 3:
						...
						break;
					case 4: c = r[i + 1], l = r[i + 2], f = r[i + 3], (c & 192) === 128 && (l & 192) === 128 && (f & 192) === 128 && (y = (s & 15) << 18 | (c & 63) << 12 | (l & 63) << 6 | f & 63, y > 65535 && y < 1114112 && (o = y));
				}
			}
...
var p = G(() => {
	"use strict";
	b = globalThis, v = globalThis.setImmediate ?? ((r) => setTimeout(r, 0)), globalThis.clearImmediate, d = typeof globalThis.Buffer == "function" && typeof globalThis.Buffer.allocUnsafe == "function" ? globalThis.Buffer : ii().Buffer, m = globalThis.process ?? {};
	m.env ?? (m.env = {});
	try {
		m.nextTick(() => {});
	} catch {
...
var ge = T((Bl, Kt) => {
	...
	R.prototype.emit = a(function(e) {
		...
		if (i) {
			...
			var u = /* @__PURE__ */ new Error("Unhandled error." + (o ? " (" + o.message + ")" : ""));
			throw u.context = o, u;
		}
		var c = s[e];
	...
	function ci(r, e, t, n) {
		...
		if (dt(t), s = r._events, s === void 0 ? (s = r._events = Object.create(null), r._eventsCount = 0) : (s.newListener !== void 0 && (r.emit("newListener", e, t.listener ? t.listener : t), s = r._events), o = s[e]), o === void 0) o = s[e] = t, ++r._eventsCount;
			...
			o.warned = !0;
			var u = /* @__PURE__ */ new Error("Possible EventEmitter memory leak detected. " + o.length + " " + String(e) + " listeners added. Use emitter.setMaxListeners() to increase limit");
	...
	function la(r, e) {
		return new Promise(function(t, n) {
			...
			a(s, "resolver"), di(r, e, s, { once: !0 }), e !== "error" && fa(r, i, { once: !0 });
		});
	}
	a(la, "once");
	function fa(r, e, t) {
		...
		connect(t, n, i) {
			...
			try {
				...
				fetch(f, { headers: { Upgrade: "websocket" } }).then((y) => {
					...
					this.emit("error", /* @__PURE__ */ new Error(`All attempts to open a WebSocket to connect to the database failed. Please refer \
...
var tr = T((Ai) => {
	...
	var vt = class vt {
		...
		consumeDimensions() {
			if (this.source[0] === "[") {
				for (; !this.isEof();) if (this.nextCharacter().value === "=") break;
			}
		}
		parse(e) {
			var t, n, i;
...
var Ti = T((ef, Ii) => {
	...
	function La(r) {
		...
		if (e) {
			...
			if (t === "Z") return 0;
			var n = t === "-" ? -1 : 1;
			return (parseInt(e[2], 10) * 3600 + parseInt(e[3] || 0, 10) * 60 + parseInt(e[4] || 0, 10)) * n * 1e3;
		}
	}
	a(La, "timeZoneOffset");
	function _i(r) {
...
var Fi = T((af, Li) => {
	...
	var ir = "([+-]?\\d+)", Qa = ir + "\\s+years?", Na = ir + "\\s+mons?", Wa = ir + "\\s+days?", Ha = new RegExp([
		Qa,
		Na,
		Wa,
		"([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?"
...
var Ki = T((bf, zi) => {
	...
	var nu = Hi(), L = a(function(r, e, t, n, i) {
		...
		return s == Math.pow(2, t + 1) - 1 ? c === 0 ? i === 0 ? Infinity : -Infinity : NaN : (i === 0 ? 1 : -1) * Math.pow(2, s - n) * c;
		...
		for (var t = Math.pow(1e4, L(r, 16, 16)), n = 0, s = L(r, 16), o = 0; o < s; o++) n += L(r, 16, 64 + 16 * o) * t, t /= 1e4;
		var u = Math.pow(10, L(r, 16, 48));
		return (e === 0 ? 1 : -1) * Math.round(n * u) / u;
	}, "parseNumeric"), Gi = a(function(r, e) {
		var t = L(e, 1), n = L(e, 63, 1), i = /* @__PURE__ */ new Date((t === 0 ? 1 : -1) * n / 1e3 + 9466848e5);
...
function Xe(r) {
	let e = 1779033703, t = 3144134277, n = 1013904242, i = 2773480762, s = 1359893119, o = 2600822924, u = 528734635, c = 1541459225, l = 0, f = 0, y = [
		...
		3204031479,
		3329325298
	], g = a((I, w) => I >>> w | I << 32 - w, "rrot"), A = /* @__PURE__ */ new Uint32Array(64), C = /* @__PURE__ */ new Uint8Array(64), D = a(() => {
		for (let B = 0, j = 0; B < 16; B++, j += 4) A[B] = C[j] << 24 | C[j + 1] << 16 | C[j + 2] << 8 | C[j + 3];
		for (let B = 16; B < 64; B++) {
			let j = g(A[B - 15], 7) ^ g(A[B - 15], 18) ^ A[B - 15] >>> 3, le = g(A[B - 2], 17) ^ g(A[B - 2], 19) ^ A[B - 2] >>> 10;
			A[B] = A[B - 16] + j + A[B - 7] + le | 0;
		}
		let I = e, w = t, Z = n, W = i, J = s, X = o, se = u, oe = c;
		for (let B = 0; B < 64; B++) {
			let j = g(J, 6) ^ g(J, 11) ^ g(J, 25), le = J & X ^ ~J & se, de = oe + j + le + y[B] + A[B] | 0, _e = (g(I, 2) ^ g(I, 13) ^ g(I, 22)) + (I & w ^ I & Z ^ w & Z) | 0;
		...
		let w = /* @__PURE__ */ new Uint8Array(32);
...
var ts = G(() => {
	...
	U = class U {
		constructor() {
			...
			E(this, "_state", /* @__PURE__ */ new Int32Array(4));
			E(this, "_buffer", /* @__PURE__ */ new ArrayBuffer(68));
			E(this, "_buffer8");
			E(this, "_buffer32");
	...
	return { update: a(function(t) {
		return { digest: a(function() {
			...
			if (n > 64) e = Xe(e);
				...
				let c = /* @__PURE__ */ new Uint8Array(64);
				c.set(e), e = c;
			}
			let i = /* @__PURE__ */ new Uint8Array(64), s = /* @__PURE__ */ new Uint8Array(64);
			for (let c = 0; c < 64; c++) i[c] = 54 ^ e[c], s[c] = 92 ^ e[c];
			let o = new Uint8Array(t.length + 64);
			o.set(i, 0), o.set(t, 64);
			let u = /* @__PURE__ */ new Uint8Array(96);
...
var rt = T((Wf, ns) => {
	...
	}, "md5"), Ru = a(function(r, e, t) {
		var n = pr(e + r);
		return "md5" + pr(d.concat([d.from(n), t]));
...
var ds = T((th, ps) => {
	...
	function Uu(r, e, t) {
		...
		var s = Wu(e, d.from(n.salt, "base64"), n.iteration), o = Ue(s, "Client Key"), u = Nu(o), c = "n=*,r=" + r.clientNonce, l = "r=" + n.nonce + ",s=" + n.salt + ",i=" + n.iteration, f = "c=biws,r=" + n.nonce, y = c + "," + l + "," + f, C = hs(o, Ue(u, y)).toString("base64"), Y = Ue(Ue(s, "Server Key"), y);
	...
	a(Ue, "hmacSha256");
	function Wu(r, e, t) {
		for (var n = Ue(r, d.concat([e, d.from([
			0,
			0,
			0,
			1
...
ie(gr, { stat: () => Hu });
function Hu(r, e) {
	e(/* @__PURE__ */ new Error("No filesystem"));
}
var br = G(() => {
	"use str\
ict";
...
var vs = T((fh, bs) => {
	...
	function zu(r, e, t) {
		...
		if (this.overflow = this[ve].length > this.maxLength, this.overflow && !this.skipOverflow) {
			t(/* @__PURE__ */ new Error("maximum buffer reached"));
			return;
		}
		t();
	}
	...
	function Yu(r, e, t) {
		switch (r = r || /\r?\n/, e = e || ws, t = t || {}, arguments.length) {
			case 1:
				...
				break;
			case 2: typeof r == "function" ? (t = e, e = r, r = /\r?\n/) : typeof e == "object" && (t = e, e = ws);
		}
...
var Es = T((dh, pe) => {
	...
	function Cr() {
		if (st instanceof Zu && st.writable === !0) {
...
`);
	...
	pe.exports.getFileName = function(r) {
		var e = r || m.env;
		return e.PGPASSFILE || (Tt ? xs.join(e.APPDATA || "./", "postgresql", "pgpass.conf") : xs.join(e.HOME || "./", ".pgpass"));
	};
	...
	var ac = pe.exports.parseLine = function(r) {
		...
		for (var e = "", t = "", n = 0, i = 0, o = {}, u = !1, c = a(function(f, y, g) {
...
var Rt = T((Ah, Ls) => {
	...
	var fc = (Is(), O(_s)), Bs = tt(), Rs = Ps().parse, H = a(function(r, e, t) {
		return t === void 0 ? t = m.env["PG" + r.toUpperCase()] : t === !1 || (t = m.env[t]), e[r] || t || Bs[r];
	}, "val"), hc = a(function() {
...
var qs = T((Rh, Os) => {
	...
	var { EventEmitter: dc } = ge(), Us = Ms(), Ds = rt(), kr = class kr extends dc {
		...
		submit(e) {
			...
			return this.text && t && this.text !== t ? /* @__PURE__ */ new Error(`Prepared statements must be unique - '${this.name}\
' was used for a different statement`) : this.values && !Array.isArray(this.values) ? /* @__PURE__ */ new Error("Query values must be an array") : (this.requiresPreparation() ? this.prepare(e) : e.query(this.text), null);
		}
		hasBeenParsed(e) {
...
var ln = T((_) => {
	...
	_.ParameterDescriptionMessage = en;
	var tn = class tn {
		constructor(e, t, n) {
	...
	_.AuthenticationMD5Password = rn;
	var nn = class nn {
		constructor(e, t, n) {
	...
	_.NotificationResponseMessage = sn;
	var on = class on {
		constructor(e, t) {
...
var Ws = T((Ft) => {
	...
	var pn = Qs(), F = new pn.Writer(), yc = a((r) => {
		...
		return dn(67, `${r.type}${r.name || ""}`);
	}, "close"), Bc = a((r) => F.add(r).flush(100), "copyData"), Lc = a((r) => dn(102, r), "copyFail"), Lt = a((r) => d.from([
		r,
		0,
		0,
		0,
		4
	]), "codeOnlyBuffer"), Fc = Lt(72), kc = Lt(83), Mc = Lt(88), Uc = Lt(99);
	Ft.serialize = {
		startup: yc,
		password: wc,
		requestSsl: mc,
...
var Gs = T((Mt) => {
	...
	Mt.Parser = void 0;
	var k = ln(), qc = js(), wn = 1, Hs = wn + 4, $s = d.allocUnsafe(0), bn = class bn {
		constructor(e) {
		...
		parse(e, t) {
			...
			for (; i + Hs <= n;) {
				...
				if (u + i <= n) t(this.handlePacket(i + Hs, s, o, this.buffer)), i += u;
				else break;
			}
		...
		handlePacket(e, t, n, i) {
			switch (t) {
				case 50: return k.bindComplete;
				case 49: return k.parseComplete;
				case 51: return k.closeComplete;
				case 110: return k.noData;
				case 115: return k.portalSuspended;
				case 99: return k.copyDone;
				case 87: return k.replicationStart;
				case 73: return k.emptyQuery;
				case 68: return this.parseDataRowMessage(e, n, i);
				case 67: return this.parseCommandCompleteMessage(e, n, i);
				case 90: return this.parseReadyForQueryMessage(e, n, i);
				case 65: return this.parseNotificationMessage(e, n, i);
				case 82: return this.parseAuthenticationResponse(e, n, i);
				case 83: return this.parseParameterStatusMessage(e, n, i);
				case 75: return this.parseBackendKeyData(e, n, i);
				case 69: return this.parseErrorMessage(e, n, i, "error");
				case 78: return this.parseErrorMessage(e, n, i, "notice");
				case 84: return this.parseRowDescriptionMessage(e, n, i);
				case 116: return this.parseParameterDescriptionMessage(e, n, i);
				case 71: return this.parseCopyInMessage(e, n, i);
				case 72: return this.parseCopyOutMessage(e, n, i);
				case 100: return this.parseCopyData(e, n, i);
				default: return new k.DatabaseError("received invalid response: " + t.toString(16), n, "error");
			}
		}
	...
	var Ks = (Fe(), O(wi)), Gc = ge().EventEmitter, { parse: Vc, serialize: Q } = vn(), Ys = Q.flush(), zc = Q.sync(), Kc = Q.end(), Sn = class Sn extends Gc {
		...
		connect(e, t) {
			...
			this.stream.once("data", function(s) {
				switch (s.toString("utf8")) {
					case "S": break;
					case "N": return n.stream.end(), n.emit("error", /* @__PURE__ */ new Error("The server does not support SSL connections"));
					default: return n.stream.end(), n.emit("error", /* @__PURE__ */ new Error("There was an error establishing an SSL connection"));
				}
				var u = (zs(), O(Vs));
...
var eo = T((np, Xs) => {
	...
	it(), O(nt);
	var Zc = rt(), An = ds(), Jc = Cs(), Xc = At(), el = Rt(), Js = qs(), tl = tt(), rl = En(), Cn = class Cn extends Yc {
		constructor(e) {
			...
			}), this.queryQueue = [], this.binary = t.binary || tl.binary, this.processID = null, this.secretKey = null, this.ssl = this.connectionParameters.ssl || !1, this.ssl && this.ssl.key && Object.defineProperty(this.ssl, "key", { enumerable: !1 }), this._connectionTimeoutMillis = t.connectionTimeoutMillis || 0;
		}
		_errorAllQueries(e) {
			let t = a((n) => {
				m.nextTick(() => {
		...
		_connect(e) {
			...
			if (this._connectionCallback = e, this._connecting || this._connected) {
				let i = /* @__PURE__ */ new Error("Client has already been connected. You cannot reuse a client.");
				m.nextTick(() => {
					e(i);
				});
				return;
			...
			this._connecting = !0, this.connectionTimeoutHandle, this._connectionTimeoutMillis > 0 && (this.connectionTimeoutHandle = setTimeout(() => {
				n._ending = !0, n.stream.destroy(/* @__PURE__ */ new Error("timeout expired"));
			}, this._connectionTimeoutMillis)), this.host && this.host.indexOf("/") === 0 ? n.connect(this.host + "/.s.PGSQL." + this.port) : n.connect(this.port, this.host), n.on("connect", function() {
				t.ssl ? n.requestSsl() : n.startup(t.getStartupConf());
			}), n.on("sslconnect", function() {
				n.startup(t.getStartupConf());
			}), this._attachListeners(n), n.once("end", () => {
				let i = this._ending ? /* @__PURE__ */ new Error("Connection terminated") : /* @__PURE__ */ new Error("Connection terminated unexpectedly");
		...
		_checkPgPass(e) {
			...
			typeof this.password == "function" ? this._Promise.resolve().then(() => this.password()).then((n) => {
				if (n !== void 0) {
					if (typeof n != "string") {
						t.emit("error", /* @__PURE__ */ new TypeError("Password must be a string"));
						return;
					}
		...
		query(e, t, n) {
			...
			return typeof e.submit == "function" ? (o = e.query_timeout || this.connectionParameters.query_timeout, s = i = e, typeof t == "function" && (i.callback = i.callback || t)) : (o = this.connectionParameters.query_timeout, i = new Js(e, t, n), i.callback || (s = new this._Promise((l, f) => {
				...
				var l = /* @__PURE__ */ new Error("Query read timeout");
				m.nextTick(() => {
				...
				i.handleError(/* @__PURE__ */ new Error("Client was closed and is not queryable"), this.connection);
			}), s) : (this.queryQueue.push(i), this._pulseQueryQueue(), s) : (m.nextTick(() => {
				i.handleError(/* @__PURE__ */ new Error("Client has encountered a connection error and is not queryable"), this.connection);
			}), s);
		}
		ref() {
			this.connection.ref();
...
var io = T((op, no) => {
	...
	function Dt(r, e) {
		...
		let t, n;
		return {
			callback: a(function(o, u) {
				o ? t(o) : n(u);
			}, "cb"),
			result: new r(function(o, u) {
				n = o, t = u;
			}).catch((o) => {
	...
	var Rn = class Rn extends nl {
		...
		connect(e) {
			if (this.ending) {
				let i = /* @__PURE__ */ new Error("Cannot use a pool after calling end on the pool");
			...
			if (this._isFull() || this._idle.length) {
				...
				let i = a((u, c, l) => {
					...
					ro(this._pendingQueue, (u) => u.callback === i), s.timedOut = !0, t.callback(/* @__PURE__ */ new Error("timeout exceeded when trying to connect"));
		...
		query(e, t, n) {
			if (typeof e == "function") {
				...
				return v(function() {
					return s.callback(/* @__PURE__ */ new Error("Passing a function as the first parameter to pool.query is not supported"));
				}), s.result;
			}
			...
			if (this.log("ending"), this.ending) {
				let n = /* @__PURE__ */ new Error("Called end on pool more than once");
...
var lo = T((fp, co) => {
	...
	var uo = ge().EventEmitter, ul = (it(), O(nt)), Bn = rt(), Ne = co.exports = function(r, e, t) {
		uo.call(this), r = Bn.normalizeQueryConfig(r, e, t), this.text = r.text, this.values = r.values, this.name = r.name, this.callback = r.callback, this.state = "new", this._arrayMode = r.rowMode === "array", this._emitRowEvents = !1, this.on("newListener", function(n) {
		...
		if (m.domain && (t = m.domain.bind(t)), this.name) {
			...
			if (r.namedQueries[this.name]) {
				if (this.text && r.namedQueries[this.name] !== this.text) {
					let s = /* @__PURE__ */ new Error(`Prepa\
red statements must be unique - '${this.name}' was used for a different statement`);
			...
			if (!Array.isArray(this.values)) return t(/* @__PURE__ */ new Error("Query values must be an array"));
...
var yo = T((yp, po) => {
	...
	ao();
	var fo = ge().EventEmitter, hl = (it(), O(nt)), pl = Rt(), ho = lo(), K = po.exports = function(r) {
		fo.call(this), r = r || {}, this._Promise = r.Promise || b.Promise, this._types = new fl(r.types), this.native = new ll({ types: this._types }), this._queryQueue = [], this._ending = !1, this._connecting = !1, this._connected = !1, this._queryable = !0;
	...
	K.prototype._connect = function(r) {
		var e = this;
		if (this._connecting) {
			m.nextTick(() => r(/* @__PURE__ */ new Error("Client has already been connected. You cannot reuse a client.")));
			return;
		}
	...
	K.prototype.query = function(r, e, t) {
		...
		return s && (u = n.callback, o = setTimeout(() => {
			var c = /* @__PURE__ */ new Error("Query read timeout");
			m.nextTick(() => {
			...
			n.handleError(/* @__PURE__ */ new Error("Client was closed and is not queryable"));
		}), i) : (this._queryQueue.push(n), this._pulseQueryQueue(), i) : (n.native = this.native, m.nextTick(() => {
			n.handleError(/* @__PURE__ */ new Error("Client has encountered a connection error and is not queryable"));
		}), i);
	};
	K.prototype.end = function(r) {
		...
		return r || (t = new this._Promise(function(n, i) {
			...
			e._errorAllQueries(/* @__PURE__ */ new Error("Connection terminated")), m.nextTick(() => {
				e.emit("end"), r && r();
			});
		}), t;
	};
...
var Si = Jt.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").slice();
Si[62] = 45;
Si[63] = 95;
var He;
var wt;
function Ea(r, { alphabet: e, scratchArr: t } = {}) {
	if (!He) if (He = /* @__PURE__ */ new Uint16Array(256), wt = /* @__PURE__ */ new Uint16Array(256), xi) for (let C = 0; C < 256; C++) He[C] = yt[C & 15] << 8 | yt[C >>> 4], wt[C] = mt[C & 15] << 8 | mt[C >>> 4];
...
function cs(r, { arrayMode: e, fullResults: t, fetchOptions: n, isolationLevel: i, readOnly: s, deferrable: o, authToken: u, disableWarningInBrowsers: c } = {}) {
	...
	a(D, "templateFn"), D.query = (P, I, w) => new Ce(Y, {
		...
		return Y(P.map((W) => W.queryData), P.map((W) => W.opts ?? {}), I);
	};
	async function Y(P, I, w) {
		let { fetchEndpoint: Z, fetchFunction: W } = ce, J = Array.isArray(P) ? { queries: P.map((ee) => ss(ee)) } : ss(P), X = n ?? {}, se = e ?? !1, oe = t ?? !1, B = i, j = s, le = o;
		w !== void 0 && (w.fetchOptions !== void 0 && (X = {
			...X,
			...w.fetchOptions
		}), w.arrayMode !== void 0 && (se = w.arrayMode), w.fullResults !== void 0 && (oe = w.fullResults), w.isolationLevel !== void 0 && (B = w.isolationLevel), w.readOnly !== void 0 && (j = w.readOnly), w.deferrable !== void 0 && (le = w.deferrable)), I !== void 0 && !Array.isArray(I) && I.fetchOptions !== void 0 && (X = {
			...X,
			...I.fetchOptions
		});
		let de = u;
		!Array.isArray(I) && I?.authToken !== void 0 && (de = I.authToken);
		let We = typeof Z == "function" ? Z(g, A, { jwtAuth: de !== void 0 }) : Z, fe = {
		...
		if (ye.ok) {
			...
			if (Array.isArray(P)) {
				...
				return M.map(($, me) => {
					let Ot = I[me] ?? {};
					return os($, {
						arrayMode: Ot.arrayMode ?? se,
						fullResults: Ot.fullResults ?? oe,
						types: Ot.types
					});
				});
			} else {
				let M = I ?? {};
				return os(ee, {
					arrayMode: M.arrayMode ?? se,
					fullResults: M.fullResults ?? oe,
					types: M.types
				});
			}
		} else {
			...
			if (ee === 400) {
				...
				throw $;
			} else throw new be(`Server error (HTTP status ${ee}): ${await ye.text()}`);
		}
	}
...
function os(r, { arrayMode: e, fullResults: t, types: n }) {
	let i = new as.default(n), s = r.fields.map((c) => c.name), o = r.fields.map((c) => i.getTypeParser(c.dataTypeID)), u = e === !0 ? r.rows.map((c) => c.map((l, f) => l === null ? null : o[f](l))) : r.rows.map((c) => Object.fromEntries(c.map((l, f) => [s[f], l === null ? null : o[f](l)])));
...
rs, please set the host to 'localhost' explicitly.`);
	...
	async _handleAuthSASLContinue(t) {
		...
		let y = parseInt(f, 10), g = d.from(l, "base64"), A = new TextEncoder(), C = A.encode(s), D = await n.importKey("raw", C, {
			name: "HMAC",
			hash: { name: "SHA-256" }
		}, !1, ["sign"]), Y = new Uint8Array(await n.sign("HMAC", D, d.concat([g, d.from([
			0,
			0,
			0,
			1
		...
		let w = P, Z = await n.importKey("raw", w, {
			name: "HMAC",
			hash: { name: "SHA-256" }
		}, !1, ["sign"]), W = new Uint8Array(await n.sign("HMAC", Z, A.encode("Client Key"))), J = await n.digest("SHA-256", W), X = "n=*,r=" + i.clientNonce, se = "r=" + c + ",s=" + l + ",i=" + y, oe = "c=biws,r=" + c, B = X + "," + se + "," + oe, j = await n.importKey("raw", J, {
			name: "HMAC",
			hash: { name: "SHA-256" }
		}, !1, ["sign"]);
		var le = new Uint8Array(await n.sign("HMAC", j, A.encode(B))), We = d.from(W.map((M, $) => W[$] ^ le[$])).toString("base64");
		let fe = await n.importKey("raw", w, {
			name: "HMAC",
			hash: { name: "SHA-256" }
		}, !1, ["sign"]), _e = await n.sign("HMAC", fe, A.encode("Server Key")), ye = await n.importKey("raw", _e, {
			name: "HMAC",
			hash: { name: "SHA-256" }
		}, !1, ["sign"]);
		var ee = d.from(await n.sign("HMAC", ye, A.encode(B)));
...
/${c(o.database)}`, f = typeof t == "string" ? t : t.text, y = n ?? t.values ?? [];
			...
			}).query(f, y, { types: t.types ?? this.options?.types }).then((A) => i(void 0, A)).catch((A) => i(A));
		} catch (o) {
			i(o);
		}
		return s.result;
...
*/
//#endregion
export { export_types as n, Mn as t };
