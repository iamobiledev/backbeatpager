...
var require_applicator = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const additionalProperties_1 = require_additionalProperties();
	const properties_1 = require_properties$1();
...
var require_ajv = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const discriminator_1 = require_discriminator$1();
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/metadata.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/ref.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/runtime/timestamp.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/error.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/type.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/nullable.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/enum.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/elements.js
var require_elements = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.default = {
		keyword: "elements",
		schemaType: "object",
		error: (0, require_error().typeError)("array"),
		code(cxt) {
			(0, metadata_1.checkMetadata)(cxt);
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/properties.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/optionalProperties.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/discriminator.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/values.js
var require_values = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.default = {
		keyword: "values",
		schemaType: "object",
		error: (0, require_error().typeError)("object"),
		code(cxt) {
			(0, metadata_1.checkMetadata)(cxt);
			const { gen, data, schema, it } = cxt;
			const [valid, cond] = (0, nullable_1.checkNullableObject)(cxt, data);
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/union.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/vocabularies/jtd/index.js
var require_jtd$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	const ref_1 = require_ref();
	const type_1 = require_type();
	const enum_1 = require_enum();
	const elements_1 = require_elements();
	const properties_1 = require_properties();
	const optionalProperties_1 = require_optionalProperties();
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/refs/jtd-schema.js
var require_jtd_schema = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const emptyForm = (root) => ({ optionalProperties: shared(root) });
	const refForm = (root) => ({
	...
	const discriminatorForm = (root) => ({
		properties: {
			...
			mapping: { values: { metadata: { union: [propertiesForm(false), optionalPropertiesForm(false)] } } }
		},
		optionalProperties: shared(root)
	});
	...
	const schema = (root) => ({ metadata: { union: [
		emptyForm,
		refForm,
		typeForm,
		enumForm,
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/compile/jtd/types.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/runtime/quote.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/compile/jtd/serialize.js
var require_serialize = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	const types_1 = require_types();
	const __1 = require_compile();
	const codegen_1 = require_codegen();
	const ref_error_1 = require_ref_error();
	const names_1 = require_names();
	const code_1 = require_code();
	...
	function serializeNumber({ gen, data, self }) {
		...
		if (self.opts.specialNumbers === void 0 || self.opts.specialNumbers === "fast") gen.add(names_1.default.json, (0, codegen_1._)`"" + ${data}`);
		else gen.if(condition, () => gen.add(names_1.default.json, (0, codegen_1._)`null`), () => gen.add(names_1.default.json, (0, codegen_1._)`"" + ${data}`));
	}
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/runtime/parseJson.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/compile/jtd/parse.js
var require_parse = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const ref_1 = require_ref();
	const type_1 = require_type();
	const parseJson_1 = require_parseJson();
	const util_1 = require_util();
	const timestamp_1 = require_timestamp();
	const genParse = {
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/jtd.js
var require_jtd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.MissingRefError = exports.ValidationError = exports.CodeGen = exports.Name = exports.nil = exports.stringify = exports.str = exports._ = exports.KeywordCxt = exports.Ajv = void 0;
	const core_1 = require_core$1();
	const jtd_1 = require_jtd$1();
	const jtd_schema_1 = require_jtd_schema();
	const serialize_1 = require_serialize();
...
//#endregion
//#region ../../node_modules/.pnpm/@fastify+ajv-compiler@4.0.5/node_modules/@fastify/ajv-compiler/lib/validator-compiler.js
var require_validator_compiler = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	const Ajv = require_ajv().default;
	const AjvJTD = require_jtd();
	...
	var ValidatorCompiler = class {
		constructor(externalSchemas, options) {
			...
			if (addFormatPlugin) require_dist()(this.ajv);
...
//#endregion
//#region ../../node_modules/.pnpm/@fastify+ajv-compiler@4.0.5/node_modules/@fastify/ajv-compiler/lib/serializer-compiler.js
...
//#endregion
//#region ../../node_modules/.pnpm/ajv@8.20.0/node_modules/ajv/dist/standalone/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/@fastify+ajv-compiler@4.0.5/node_modules/@fastify/ajv-compiler/standalone.js
...
//#endregion
//#region ../../node_modules/.pnpm/@fastify+ajv-compiler@4.0.5/node_modules/@fastify/ajv-compiler/index.js
...
//#endregion
export { require_equal as a, require_ajv as i, require_dist as n, require_fast_deep_equal as o, require_formats as r, require_ajv_compiler as t };
