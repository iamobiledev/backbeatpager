...
import { t as require_forwarded } from "./fastify__forwarded.mjs";
//#region ../../node_modules/.pnpm/ipaddr.js@2.4.0/node_modules/ipaddr.js/lib/ipaddr.js
...
//#endregion
//#region ../../node_modules/.pnpm/@fastify+proxy-addr@5.1.0/node_modules/@fastify/proxy-addr/index.js
/*!
* proxy-addr
	...
	*/
	function compile(val) {
		...
		for (let i = 0; i < trust.length; i++) {
			val = trust[i];
			if (!Object.hasOwn(IP_RANGES, val)) continue;
			val = IP_RANGES[val];
		...
		return function trust(addr) {
			...
			for (let i = 0; i < subnets.length; i++) {
				...
				if (kind !== subnetkind) {
					...
					if (subnetisipv4 && !ip.isIPv4MappedAddress()) continue;
					if (!ipconv) ipconv = subnetisipv4 ? ip.toIPv4Address() : ip.toIPv4MappedAddress();
					trusted = ipconv;
				}
...
//#endregion
export { require_proxy_addr as t };
