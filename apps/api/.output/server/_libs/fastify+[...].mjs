...
import { t as require_avvio } from "./avvio+fastq+reusify.mjs";
...
import { o as require_fast_deep_equal, t as require_ajv_compiler } from "./@fastify/ajv-compiler+[...].mjs";
import { t as require_lib } from "./fast-querystring.mjs";
import { t as require_dist$1 } from "./cookie.mjs";
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/symbols.js
...
//#endregion
//#region ../../node_modules/.pnpm/process-warning@5.0.0/node_modules/process-warning/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/warnings.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/errors.js
var require_errors = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const codes = {
		...
		*/
		...
		FST_ERR_LOG_INVALID_LOG_CONTROLLER: createError("FST_ERR_LOG_INVALID_LOG_CONTROLLER", "logController option must be an instance of LogController, got '%s'.", 500, TypeError),
		/**
		* reply
		*/
		...
		*/
		...
		FST_ERR_MAX_PARAM_LENGTH: createError("FST_ERR_MAX_PARAM_LENGTH", "'%s' is exceeding the max param length", 414, URIError),
		...
		FST_ERR_ROUTE_LOG_LEVEL_INVALID: createError("FST_ERR_ROUTE_LOG_LEVEL_INVALID", "Log level for '%s:%s' route must be a valid logger level. Received: '%s'", 500, TypeError),
		...
		*/
		...
		FST_ERR_PLUGIN_DEPENDENCY_NOT_REGISTERED: createError("FST_ERR_PLUGIN_DEPENDENCY_NOT_REGISTERED", "The dependency '%s' of plugin '%s' is not registered"),
		/**
		*  Avvio Errors
		*/
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/hooks.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/noop-set.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/promise.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/server.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/error-status.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/wrap-thenable.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/validation.js
var require_validation = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function validate(context, request, execution) {
		...
		if (runExecution && context[paramsSchema] === void 0 && context[bodySchema] === void 0 && context[querystringSchema] === void 0 && context[headersSchema] === void 0) return false;
...
//#endregion
//#region ../../node_modules/.pnpm/toad-cache@3.7.4/node_modules/toad-cache/dist/toad-cache.cjs
/**
* toad-cache
*
	...
	*/
	...
	var HitStatisticsRecord = class {
		...
		initForCache(cacheId, currentTimeStamp) {
			this.records[cacheId] = { [currentTimeStamp]: createEmptyStatisticsRecord() };
		}
		resetForCache(cacheId) {
			if (!this.records[cacheId]) return;
			for (let key of Object.keys(this.records[cacheId])) this.records[cacheId][key] = createEmptyStatisticsRecord();
		}
		getStatistics() {
			return this.records;
		}
	...
	*/
	...
	var HitStatistics = class {
		...
		get currentRecord() {
			...
			/* c8 ignore next 3 */
			if (!cacheRecords[this.currentTimeStamp]) cacheRecords[this.currentTimeStamp] = createEmptyStatisticsRecord();
	...
	var LruObjectHitStatistics = class extends LruObject {
		...
		evict() {
			...
			super.evict();
			if (hadItems) this.hitStatistics.addEviction();
			this.hitStatistics.setCacheSize(this.size);
		}
		delete(key, isExpiration = false) {
			const existed = this.items[key] !== void 0;
			super.delete(key);
			if (existed && !isExpiration) this.hitStatistics.addInvalidateOne();
			this.hitStatistics.setCacheSize(this.size);
		}
		clear() {
			super.clear();
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/content-type.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/handle-request.js
var require_handle_request = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const { setErrorStatusCode } = require_error_status();
	const { kReplyIsError, kRouteContext, kFourOhFourContext, kSupportedHTTPMethods, kRequestContentType, kDiagnosticsStore } = require_symbols$1();
	...
	function handleRequest(err, request, reply) {
		...
		if (this[kSupportedHTTPMethods].bodywith.has(method)) {
			...
			if (!request[kRequestContentType]) request[kRequestContentType] = ContentType.from(ctHeader);
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/config-validator.js
/* c8 ignore start */
...
/* c8 ignore stop */
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/initial-config-validation.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/log-controller.js
	...
	var LogController = class {
		...
		*/
		defaultErrorLog(error, request, reply, metadata) {
			if (this.isLogDisabled(request)) return;
			if (reply.statusCode >= 500) reply.log.error({
				req: request,
				res: reply,
				err: error
			}, error?.message);
...
//#endregion
//#region ../../node_modules/.pnpm/thread-stream@4.2.0/node_modules/thread-stream/lib/wait.js
...
//#endregion
//#region ../../node_modules/.pnpm/thread-stream@4.2.0/node_modules/thread-stream/lib/indexes.js
...
var require_thread_stream = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const { WRITE_INDEX, READ_INDEX, SEQ_INDEX } = require_indexes();
	...
	function createWorker(stream, opts) {
		...
		const toExecute = ("__bundlerPathsOverrides" in globalThis ? globalThis.__bundlerPathsOverrides : {})["thread-stream-worker"] || join$1(__dirname, "lib", "worker.js");
...
var require_levels = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const { DEFAULT_LEVELS, SORTING_ORDER } = require_constants$1();
	const levelMethods = {
		fatal: (hook) => {
...
var require_multistream = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const { DEFAULT_LEVELS } = require_constants$1();
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/logger-pino.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/logger-factory.js
var require_logger_factory = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	const { performance } = __require("node:perf_hooks");
	const { FST_ERR_LOG_LOGGER_AND_LOGGER_INSTANCE_PROVIDED, FST_ERR_LOG_INVALID_LOGGER_CONFIG, FST_ERR_LOG_INVALID_LOGGER_INSTANCE, FST_ERR_LOG_INVALID_LOGGER, FST_ERR_LOG_INVALID_LOG_CONTROLLER } = require_errors();
	const { kLogController } = require_symbols$1();
	const { LogController } = require_log_controller();
	/**
	...
	*/
	function createChildLogger(context, logger, req, reqId, loggerOpts) {
		const loggerBindings = { [context.server[kLogController].requestIdLogLabel]: reqId };
	...
	*/
	...
	function createLogController(options) {
		...
		if (!userController) return new LogController(options);
		if (userController instanceof LogController) return userController;
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/schemas.js
	...
	function getSchemaSerializer(context, statusCode, contentType) {
		...
		if (responseSchemaDef[statusCode]) {
			if (responseSchemaDef[statusCode].constructor === Object) {
				...
				if (ct.isValid) {
					if (responseSchemaDef[statusCode][ct.mediaType]) return responseSchemaDef[statusCode][ct.mediaType];
		...
		if (responseSchemaDef[fallbackStatusCode]) {
			if (responseSchemaDef[fallbackStatusCode].constructor === Object) {
				const ct = new ContentType(contentType);
				if (ct.isValid) {
					if (responseSchemaDef[fallbackStatusCode][ct.mediaType]) return responseSchemaDef[fallbackStatusCode][ct.mediaType];
		...
		if (responseSchemaDef.default) {
			if (responseSchemaDef.default.constructor === Object) {
				const ct = new ContentType(contentType);
				if (ct.isValid) {
					if (responseSchemaDef.default[ct.mediaType]) return responseSchemaDef.default[ct.mediaType];
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/error-serializer.js
/* c8 ignore start */
var require_error_serializer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = function anonymous(validator, serializer) {
		...
		const JSON_STR_EMPTY_OBJECT = "{}";
		const JSON_STR_EMPTY_STRING = "\"\"";
		function anonymous0(input) {
			...
			if (value_code_2 !== void 0) {
				!addComma_0 && (addComma_0 = true) || (json += JSON_STR_COMMA);
				json += "\"code\":";
				if (typeof value_code_2 !== "string") if (value_code_2 === null) json += JSON_STR_EMPTY_STRING;
				else if (value_code_2 instanceof Date) json += JSON_STR_QUOTE + value_code_2.toISOString() + JSON_STR_QUOTE;
				else if (value_code_2 instanceof RegExp) json += asString(value_code_2.source);
				else json += asString(value_code_2.toString());
				else json += asString(value_code_2);
			}
			const value_error_3 = obj["error"];
			if (value_error_3 !== void 0) {
				!addComma_0 && (addComma_0 = true) || (json += JSON_STR_COMMA);
				json += "\"error\":";
				if (typeof value_error_3 !== "string") if (value_error_3 === null) json += JSON_STR_EMPTY_STRING;
				else if (value_error_3 instanceof Date) json += JSON_STR_QUOTE + value_error_3.toISOString() + JSON_STR_QUOTE;
				else if (value_error_3 instanceof RegExp) json += asString(value_error_3.source);
				else json += asString(value_error_3.toString());
				else json += asString(value_error_3);
			}
			const value_message_4 = obj["message"];
			if (value_message_4 !== void 0) {
				!addComma_0 && (addComma_0 = true) || (json += JSON_STR_COMMA);
				json += "\"message\":";
				if (typeof value_message_4 !== "string") if (value_message_4 === null) json += JSON_STR_EMPTY_STRING;
				else if (value_message_4 instanceof Date) json += JSON_STR_QUOTE + value_message_4.toISOString() + JSON_STR_QUOTE;
				else if (value_message_4 instanceof RegExp) json += asString(value_message_4.source);
				else json += asString(value_message_4.toString());
				else json += asString(value_message_4);
			}
...
/* c8 ignore stop */
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/error-handler.js
var require_error_handler = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	const statusCodes = __require("node:http").STATUS_CODES;
	const wrapThenable = require_wrap_thenable();
	const { setErrorStatusCode } = require_error_status();
	const { kReplyHeaders, kReplyNextErrorHandler, kReplyIsRunningOnErrorHook, kRouteContext, kLogController, kDiagnosticsStore } = require_symbols$1();
	...
	function handleError(reply, error, cb) {
		...
		try {
			...
			if (result !== void 0) if (result !== null && typeof result.then === "function") {
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/decorate.js
var require_decorate = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function decorateConstructor(konstructor, name, fn, dependencies) {
		...
		if (Object.hasOwn(instance, name) || hasKey(konstructor, name) || hasInstanceProperty(konstructor, name)) throw new FST_ERR_DEC_ALREADY_PRESENT(name);
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/reply.js
var require_reply = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	Reply.props = [];
	Reply.instanceProperties = /* @__PURE__ */ new Set([
		"raw",
		"request",
		"log"
	]);
	...
	Reply.prototype.send = function(payload) {
		...
		if (payload !== null) {
			if (typeof payload.pipe === "function" || typeof payload.getReader === "function" || typeof payload === "object" && toString.call(payload) === "[object Response]") {
				onSendHook(this, payload);
				return this;
			}
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/request.js
var require_request$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	Request.props = [];
	Request.instanceProperties = /* @__PURE__ */ new Set([
		"id",
		"params",
		"raw",
		"query",
	...
	function buildRequestWithTrustProxy(R, trustProxy) {
		...
		Object.defineProperties(_Request.prototype, {
			...
			host: { get() {
				...
				if (this.headers["x-forwarded-host"] && socket != null && proxyFn(socket.remoteAddress, 0)) return getLastEntryInMultiHeaderValue(this.headers["x-forwarded-host"]);
				/**
			...
			protocol: { get() {
				const socket = this.raw.socket;
				if (this.headers["x-forwarded-proto"] && socket != null && proxyFn(socket.remoteAddress, 0)) return getLastEntryInMultiHeaderValue(this.headers["x-forwarded-proto"]);
	...
	Object.defineProperties(Request.prototype, {
		...
		port: { get() {
			const matches = /(?<port>:\d+)$/.exec(this.host);
			if (matches === null || matches[1] === void 0) return null;
		...
		mediaType: { get() {
			if (!this[kRequestContentType] && this.headers["content-type"] !== void 0) this[kRequestContentType] = ContentType.from(this.headers["content-type"]);
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/context.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/content-type-parser.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/schema-controller.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/plugin-utils.js
var require_plugin_utils = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const { FST_ERR_PLUGIN_VERSION_MISMATCH, FST_ERR_PLUGIN_NOT_PRESENT_IN_INSTANCE, FST_ERR_PLUGIN_INVALID_ASYNC_HANDLER, FST_ERR_PLUGIN_DEPENDENCY_NOT_REGISTERED } = require_errors();
	...
	function checkDependencies(fn) {
		...
		dependencies.forEach((dependency) => {
			if (!this[kRegisteredPlugins].includes(dependency)) throw new FST_ERR_PLUGIN_DEPENDENCY_NOT_REGISTERED(dependency, meta.name);
		});
	}
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/req-id-gen-factory.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/types/tokens.js
var require_tokens = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/types/types.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/types/set-lookup.js
var require_set_lookup = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/types/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/sets.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/util.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/tokenizer.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/sets-lookup.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/write-set-tokens.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/reconstruct.js
...
//#endregion
//#region ../../node_modules/.pnpm/ret@0.5.0/node_modules/ret/dist/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/safe-regex2@5.1.1/node_modules/safe-regex2/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/strategies/http-method.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/pretty-print.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/null-object.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/handler-storage.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/node.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/strategies/accept-version.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/strategies/accept-host.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/constrainer.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/http-methods.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/lib/url-sanitizer.js
...
//#endregion
//#region ../../node_modules/.pnpm/find-my-way@9.6.0/node_modules/find-my-way/index.js
var require_find_my_way = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		while (true) {
			...
			if (node === null) {
				if (brothersNodesStack.length === 0) {
					if (maxParamLengthExceeded && this.onMaxParamLength) return this._onMaxParamLength(originPath);
					return null;
				}
			...
			if (currentNode.isRegex) {
				...
				for (let i = 1; i < matchedParameters.length; i++) if (matchedParameters[i].length > maxParamLength) {
				...
				for (let i = 1; i < matchedParameters.length; i++) params.push(matchedParameters[i]);
			} else {
	...
	Router.prototype._onMaxParamLength = function(path) {
		if (this.onMaxParamLength === null) return null;
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/head-route.js
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/route.js
var require_route = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function buildRouting(options) {
		...
		*/
			...
			function addNewRoute({ path, prefixing = false, isFastify = false }) {
				...
				try {
					...
					if (!context[kRouteByFastify]) {
						if ((Array.isArray(opts.method) ? opts.method : [opts.method]).some((method) => error.message.includes(`Method '${method}' already declared for route`))) throw new FST_ERR_DUPLICATED_ROUTE(opts.method, opts.url);
						throw error;
					}
				}
		...
		function routeHandler(req, res, params, context, query) {
			...
			let childLogger;
			if (hasLogger === false && context.childLoggerFactory === defaultChildLoggerFactory) childLogger = logger;
			else {
	...
	function validateLogLevelOption(logLevel, method, path, logger) {
		...
		if (typeof logLevel !== "string" || logger.levels.values[logLevel] === void 0) throw new FST_ERR_ROUTE_LOG_LEVEL_INVALID(method, path, logLevel);
	}
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/four-oh-four.js
var require_four_oh_four = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	const FindMyWay = require_find_my_way();
	const Reply = require_reply();
	const Request = require_request$1();
	const Context = require_context();
	const { kRoutePrefix, kCanSetNotFoundHandler, kFourOhFourLevelInstance, kFourOhFourContext, kHooks, kErrorHandler, kLogController } = require_symbols$1();
...
//#endregion
//#region ../../node_modules/.pnpm/fastify@5.10.0/node_modules/fastify/lib/plugin-override.js
var require_plugin_override = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function buildRoutePrefix(instancePrefix, pluginPrefix) {
		...
		else if (pluginPrefix[0] !== "/" && !instancePrefix.endsWith("/")) pluginPrefix = "/" + pluginPrefix;
		return instancePrefix + pluginPrefix;
	}
}));
//#endregion
//#region ../../node_modules/.pnpm/process-warning@4.0.1/node_modules/process-warning/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/light-my-request@6.6.0/node_modules/light-my-request/lib/parse-url.js
...
//#endregion
//#region ../../node_modules/.pnpm/light-my-request@6.6.0/node_modules/light-my-request/lib/form-data.js
...
//#endregion
//#region ../../node_modules/.pnpm/light-my-request@6.6.0/node_modules/light-my-request/lib/request.js
...
//#endregion
//#region ../../node_modules/.pnpm/light-my-request@6.6.0/node_modules/light-my-request/lib/response.js
...
//#endregion
//#region ../../node_modules/.pnpm/light-my-request@6.6.0/node_modules/light-my-request/lib/config-validator.js
/* c8 ignore start */
...
//#endregion
//#region ../../node_modules/.pnpm/light-my-request@6.6.0/node_modules/light-my-request/index.js
...
var require_fastify = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const { createChildLogger, defaultChildLoggerFactory, createLogger, createLogController, LogController } = require_logger_factory();
	const pluginUtils = require_plugin_utils();
	...
	const { FST_ERR_ASYNC_CONSTRAINT, FST_ERR_BAD_URL, FST_ERR_MAX_PARAM_LENGTH, FST_ERR_OPTIONS_NOT_OBJ, FST_ERR_QSP_NOT_FN, FST_ERR_SCHEMA_CONTROLLER_BUCKET_OPT_NOT_FN, FST_ERR_AJV_CUSTOM_OPTIONS_OPT_NOT_OBJ, FST_ERR_AJV_CUSTOM_OPTIONS_OPT_NOT_ARR, FST_ERR_INSTANCE_ALREADY_LISTENING, FST_ERR_REOPENED_CLOSE_SERVER, FST_ERR_ROUTE_REWRITE_NOT_STR, FST_ERR_SCHEMA_ERROR_FORMATTER_NOT_FN, FST_ERR_ERROR_HANDLER_NOT_FN, FST_ERR_ERROR_HANDLER_ALREADY_SET, FST_ERR_ROUTE_METHOD_INVALID } = errorCodes;
	const { buildErrorHandler } = require_error_handler();
	const { FSTWRN004, FSTDEP023, FSTDEP024 } = require_warnings();
	const initChannel = diagnostics.channel("fastify.initialization");
	/**
	* @param {import('./fastify.js').FastifyServerOptions} serverOptions
	*/
	function fastify(serverOptions) {
		const { options, genReqId, logController, hasLogger, initialConfig } = processOptions(serverOptions, defaultRoute, onBadUrl, onMaxParamLength);
			...
			fastify.onClose((instance, done) => {
				...
				hookRunnerApplication("preClose", fastify[kAvvioBoot], fastify, function() {
					if (fastify[kState].listening) {
						...
						if (forceCloseConnections === "idle" && options.serverFactory) instance.server.closeIdleConnections();
		...
		function setErrorHandler(func) {
			...
			else if (this[kErrorHandlerAlreadySet]) FSTWRN004();
	...
	function processOptions(options, defaultRoute, onBadUrl, onMaxParamLength) {
		...
		if (options.requestIdLogLabel !== void 0) FSTDEP024();
		options.bodyLimit = options.bodyLimit || defaultInitOptions.bodyLimit;
		if (options.disableRequestLogging !== void 0) FSTDEP023();
