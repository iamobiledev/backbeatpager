...
var require_get_vercel_oidc_token = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	async function getVercelOidcToken(options) {
		...
		try {
			const [{ getTokenPayload, isExpired }, { refreshToken }] = await Promise.all([await import("./_2.mjs").then((m) => /* @__PURE__ */ __toESM(m.default)), await import("./_6.mjs").then((m) => /* @__PURE__ */ __toESM(m.default))]);
...
var require_get_vercel_oidc_token_with_refresh = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	async function getVercelOidcToken(options) {
		...
		try {
			const [{ getTokenPayload, isExpired }, { refreshToken }] = await Promise.all([await import("./_3.mjs").then((m) => /* @__PURE__ */ __toESM(m.default)), await import("./_7.mjs").then((m) => /* @__PURE__ */ __toESM(m.default))]);
			if (!token || isExpired(getTokenPayload(token), options?.expirationBufferMs)) {
				await refreshToken(options);
				token = (0, import_get_vercel_oidc_token_sync.getVercelOidcTokenSync)();
			}
...
//#endregion
//#region ../../node_modules/.pnpm/@vercel+oidc@3.8.0/node_modules/@vercel/oidc/dist/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/@vercel+oidc@3.8.0/node_modules/@vercel/oidc/dist/token.js
...
//#endregion
export { require_dist$1 as a, require_token_util as i, require_token$1 as n, require_token_util$1 as o, require_dist as r, require_token as t };
